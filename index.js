...
let total = 0;
let totalChange = 0;
let previousMonthProfit = finances[0][1]; // Profit/Loss for the first month
let numberOfChanges = finances.length - 1;
...
for (let i = 1; i < finances.length; i++) {
  ...
  // Update previousMonthProfit for the next iteration
  previousMonthProfit = currentMonthProfit;
}
